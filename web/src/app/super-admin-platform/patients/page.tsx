...
function Icon({ name, className = "h-5 w-5" }: { name: IconName; className?: string }) {
  ...
  return (
    <svg viewBox="0 0 52 52" className={className} aria-hidden>
      <path fill={color} d="M21.6654 19.5013C21.6654 17.1071 23.6046 15.168 25.9988 15.168C28.3929 15.168 30.3321 17.1071 30.3321 19.5013C30.3321 21.8955 28.3929 23.8346 25.9988 23.8346C23.6046 23.8346 21.6654 21.8955 21.6654 19.5013ZM31.4154 36.8346H32.4988C33.6904 36.8346 34.6654 35.8596 34.6654 34.668V29.4896C34.6654 28.2763 34.0046 27.1605 32.9213 26.608C32.4554 26.3696 31.9571 26.1421 31.4154 25.9363V36.8346ZM26.3671 31.418L29.2488 25.2755C28.2413 25.048 27.1579 24.918 25.9988 24.918C23.2579 24.918 20.8963 25.6763 19.0763 26.608C18.5477 26.8802 18.1048 27.2936 17.797 27.8023C17.4891 28.311 17.3282 28.895 17.3321 29.4896V36.8346H19.8671C19.6288 36.3471 19.4988 35.7946 19.4988 35.2096C19.4988 33.1188 21.1996 31.418 23.2904 31.418H26.3671ZM23.8321 36.8346L25.3596 33.5846H23.2904C22.3913 33.5846 21.6654 34.3105 21.6654 35.2096C21.6654 36.1088 22.3913 36.8346 23.2904 36.8346H23.8321Z" />
    </svg>
  );
}
...
export default function SuperAdminPatientsRoute() {
  ...
  const exportRows = () => {
    ...
    if (!rows.length) {
      toast.info("There are no patient rows to export.");
      return;
    }
    exportTablePdf({
      ...
      rows,
      filters: [
        (search.trim() || searchText.trim()) ? `Search: ${search.trim() || searchText.trim()}` : "",
