  ...
  if (type === "reports") {
    return (
      <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        <path
          fill={color}
          d="M5 3h11l3 3v15H5V3Zm2 4v2h10V7H7Zm0 4v2h10v-2H7Zm0 4v2h6v-2H7Zm10.5 2.5h-2v-4h2v4Zm-3 0h-2v-2.5h2v2.5Z"
        />
      </svg>
    );
  }
...
export function ProfessionalPlatformShell({
  ...
  const isActiveNavItem = (href: string) => {
    if (href === "/professional-platform") {
      return normalizedPathname === "/professional-platform" || normalizedPathname === "/professional-platform/dashboard";
    }
