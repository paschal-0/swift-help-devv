...
import { forgotPassword, getApiErrorMessage } from "@/services/authApi";
...
export function ForgotPasswordPage() {
  ...
  useEffect(() => {
    ...
    showValidationToast("forgot-password", validationError);
          ...
          <div className="relative mx-auto flex w-full max-w-[491px] flex-col items-center xl:pt-[174px]">
            ...
            >
              ...
              >
                ...
                <p className="m-0 max-w-[341px] text-[16px] font-light leading-5 tracking-[-0.04em] text-black sm:text-[18px] sm:leading-[22px] sm:tracking-[-0.05em]">
              ...
              <motion.form
                ...
                className="mt-10 w-full rounded-[32px] bg-white px-5 py-8 shadow-[0_18px_36px_rgba(15,23,42,0.06)] sm:px-[25px] sm:py-[34px] xl:mt-[54px] xl:min-h-[266px] xl:shadow-[0_0_30px_rgba(0,0,0,0.05)]"
              >
                ...
                {hasSubmitted ? (
                  <p className="mt-4 text-center text-[13px] font-normal leading-5 tracking-[-0.04em] text-[#1565C0]">
